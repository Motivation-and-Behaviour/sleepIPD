...
```{r echo=FALSE}
knitr::kable(sleepIPD:::thresholds, 
             col.names = c("Age", "Device","Wear Location", "Light Threshold", 
                           "Moderate Threshold", "Vigorous Threshold"),
             caption = "Thresholds for physical activity intensity.")
```

Note that

## Using `sleepIPD` to Collate Results
