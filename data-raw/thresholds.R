...
thresholds <-
  dplyr::tribble(
    ...
    "children", "geneactiv", "wrist", 51.6, 191.6, 695.8,
    "Light: [Hurter et al., 2018](https://doi.org/10.3390/children5120172)<br>
    ...
    "children", "actigraph", "wrist", 48.1, 201.4, 707,
    "Light: [Hurter et al., 2018](https://doi.org/10.3390/children5120172)<br>
    Mod: [Hildebrand et al., 2014](https://doi.org/10.1249/mss.0000000000000289)<br>
    Vig: [Hildebrand et al., 2014](https://doi.org/10.1249/mss.0000000000000289)",
    "children", "geneactiv", "hip", 64.1, 152.8, 514.3,
    "Light: [Hildebrand et al., 2016](https://doi.org/10.1111/sms.12795)<br>
    Mod: [Hildebrand et al., 2014](https://doi.org/10.1249/mss.0000000000000289)<br>
    Vig: [Hildebrand et al., 2014](https://doi.org/10.1249/mss.0000000000000289)",
    "children", "actigraph", "hip", 32.6, 142.6, 464.6,
    "Light: [Hurter et al., 2018](https://doi.org/10.3390/children5120172)<br>
    Mod: [Hildebrand et al., 2014](https://doi.org/10.1249/mss.0000000000000289)<br>
    Vig: [Hildebrand et al., 2014](https://doi.org/10.1249/mss.0000000000000289)",
